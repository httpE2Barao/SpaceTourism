...
const Header = () => {
  return (
    <header className='relative flex items-center py-5 px-6 md:pl-10 justify-between'>
      ...
      {/* Header Line */}
      <div className='hidden w-2/3 h-0.5 bg-cinza/30'></div>
      {/* Nav Bar Desktop */}
      ...
      <ul className='
        hidden
        absolute top-0 right-0 md:top-5
        h-screen md:h-24 
        ...
        <li className='cursor-pointer uppercase pr-100 py-8 hover:border-r-4 md:hover:border-r-0 md:hover:border-b-4'>

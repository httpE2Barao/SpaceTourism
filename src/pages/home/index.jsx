  ...
  return (
    <>
      <article className="home">
        <section className="flex flex-col h-full text-center px-2 justify-evenly
          md:flex-row md:items-center 
        ">
          <div className="flex flex-col gap-4 md:w-1/2 md:text-left md:pl-20">
            <h2 className="text-text font-secondary uppercase text-md lg:text-base md:pl-10 tracking-widest">
              pronto para viajar pelo</h2>
            <h1 className="text-branco font-main uppercase text-6xl md:text-7xl lg:text-9xl md:pl-10">
              Espaço</h1>
            <p className="mx-auto px-4 md:pl-10 text-text font-secondary text-sm md:text-sm lg:text-base tracking-widest">

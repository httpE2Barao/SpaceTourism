...
const Tecnologia = () => {
  ...
  return (
    <>
      <div className="p-4 font-secondary tracking-widest text-center md:mr-auto md:mt-8 md:ml-8 md:text-left">
      ...
      <section className="screen_size font-secondary text-branco flex flex-col items-center p-4 pb-10 gap-8 md:gap-6 md:pb-14 lg:flex-row lg:pb-0 lg:gap-10 lg:mr-auto">
        <img
        ...
        <ul className="order-1 flex gap-10 font-main md:mb-4 lg:flex-col lg:ml-5">
          {elementos.map((element, index) => (
            <li
              ...
              } flex items-center justify-center w-14 h-14 rounded-full hover:cursor-pointer`}
            >
              {index}
            </li>
          ))}
        ...
        <section className="order-2 flex flex-col items-center lg:items-start lg:gap-6 lg:w-9/12">
          <div className="text-center">
            <h3 className="font-main text-cinza font-semibold uppercase text-lg lg:text-left">
              Tecnologia{currentElement === 'Veiculo' ? ' do' : ' da'}
            </h3>
            <h2 className="font-main uppercase text-5xl pt-2 tracking-widest">{currentElement}</h2>
          </div>

          {currentElement === 'Veiculo' && (
            <p className="mx-2 mb-8 md:w-2/3 md:tracking-widest text-center font-secondary text-lg tracking-wide lg:text-left">
